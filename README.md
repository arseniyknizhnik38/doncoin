...
Ранг зависит от баланса DONC и **не хранится в базе** — вычисляется на лету
функцией `resolveRank`. Пороги вынесены в
...
| Ранг | Порог DONC | Открывает |
| --- | --- | --- |
| Аутсайдер | 0 | — |
| Приближённый | 200 000 | — |
| Солдат | 500 000 | вступление в кланы |
| Капо | 5 000 000 | — |
| Консильери | 10 000 000 | — |
| Дон | 16 000 000 | — |
